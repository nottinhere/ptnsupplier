...
import 'package:ptnsupplier/scaffold/edit_deal_raise.dart';
...
class DetailDealraise extends StatefulWidget {
  final DealraiseModel? dealModel;
  final UserModel? userModel;

  DetailDealraise({Key? key, this.dealModel, this.userModel}) : super(key: key);

  @override
  _DetailDealraiseState createState() => _DetailDealraiseState();
}

class _DetailDealraiseState extends State<DetailDealraise> {
  // Explicit
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            // currentDealModel!.actiondate!,
            DateFormat('dd/MM/yyyy').format(DateFormat('yyyy-MM-dd').parse(currentDealModel!.actiondate!)),
